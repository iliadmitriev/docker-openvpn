...
declare -x OVPN_CN=94.131.104.125
...
declare -x OVPN_ENV=/Users/dmitriev/git/docker-openvpn/ovpn_env.sh
...
declare -x OVPN_PUSH=([0]="dhcp-option DNS 172.25.0.3")
declare -x OVPN_ROUTES=([0]="192.168.254.0/24")
declare -x OVPN_SERVER=192.168.255.0/24
declare -x OVPN_SERVER_URL=udp://94.131.104.125
